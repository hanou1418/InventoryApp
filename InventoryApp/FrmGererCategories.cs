...
{
    /// <summary>
    /// Fenêtre de gestion complète des Catégories (liste + CRUD).
    /// Chaque ligne a un bouton Modifier et un bouton Supprimer,
    /// avec les mêmes icônes que le reste de l'application.
    /// La suppression est protégée : impossible si des modèles
    /// utilisent encore cette catégorie (vérification préalable +
    /// filet de sécurité via la contrainte FOREIGN KEY de la base).
    /// </summary>
    public class FrmGererCategories : Form
    {
        ...
        public FrmGererCategories(Form1? mainForm)
        {
            _mainForm = mainForm;
        ...
        private void ConstruireControles()
        {
            ...
            lblHeaderTitle = new Label { Text = "Gérer les catégories", Font = new Font("Segoe UI", 11F, FontStyle.Bold), ForeColor = Color.White, BackColor = Color.Transparent, AutoSize = true, Left = 20, Top = 14 };
            ...
            btnNouveau = new Guna2Button { Text = "+ Nouvelle catégorie", Left = 20, Top = 65, Width = 180, Height = 36, BorderRadius = 6, FillColor = Color.FromArgb(59, 130, 246), ForeColor = Color.White };
        ...
        private void Dgv_CellClick(object? sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (colName == "colSupprimer")
            {
                ...
                {
                    MessageBox.Show(
                        $"Impossible de supprimer '{designation}' : {nbModeles} modèle(s) utilisent encore cette catégorie.\n\n" +
